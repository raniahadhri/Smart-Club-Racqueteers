...
int MainWindow::update_label()
{int i=-1;
    data=arduino.read_from_arduino();
    if(data=="0"){ui->le_arduino->setText("la voiture est trop loin du capteur"); i=0;}//blanche
    if(data=="1"){ui->le_arduino->setText("La voiture est dans la bonne zone ");i=1;}//vert
    if(data=="2"){ui->le_arduino->setText("La voiture est trop proche du capture");i=2;}//rouge
return i;}
//******************************table EQUIPEMENT************************************
...
void MainWindow::on_pb_charger_clicked()
{
   Equipement E2;
...
void MainWindow::on_pb_pfd_clicked()
{Equipement E4;
    QPrinter printer;
...
void MainWindow::on_pb_supprimer_f_clicked()
...
void MainWindow::on_pb_changer_f_clicked()
{int k=0;
      ui->erreur_f->clear();
...
void MainWindow::on_pb_ajoute_f_clicked()
{   int k=0;
    ui->erreur_f->clear();
    int id_fournisseur=ui->le_id_2->text().toInt();
     int telephone=ui->le_telephone->text().toInt();
...
void MainWindow::on_pb_pfd_f_clicked()
{Fournisseur F4;
    QPrinter printer;
    printer.setOutputFormat(QPrinter::PdfFormat);
    printer.setOutputFileName("fournisseur.pdf");
    QPainter painter;
    if(!painter.begin(&printer)){
        qWarning("failed to open");}
        ...
        painter.drawPixmap(QRect(10,30,750,100),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/rec.jpg"));
        painter.drawPixmap(QRect(10,1020,750,70),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/rec.jpg"));
        painter.drawPixmap(QRect(50,1020,70,70),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/logo1.png"));
        painter.drawPixmap(QRect(150,1020,70,70),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/logo2.png"));
        painter.drawPixmap(QRect(250,1020,70,70),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/logo3.png"));
        painter.drawPixmap(QRect(350,1020,70,70),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/logo4.png"));
        painter.drawPixmap(QRect(450,1020,70,70),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/logo5.png"));
        painter.drawPixmap(QRect(550,1020,70,70),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/logo6.png"));


        painter.drawPixmap(QRect(30,130,700,850),QPixmap("C:/Atelier_Connexion-20210307T163152Z-001/build-Atelier_Connexion-Desktop_Qt_5_9_9_MinGW_32bit-Debug/tennis07.jpg"));
        ...
        painter.drawText(200,200,"Téléphone");
        painter.drawText(350,200,"Facture");

        painter.drawText(600,200,"nom&prenom");
        painter.drawText(650,200,"entreprise");
        ...
        if(qry.exec())
            ...
            QString nom_pre = qry.value(3).toString();
            QString entrep = qry.value(4).toString();

        painter.drawText(100,300+i,id);
        painter.drawText(200,300+i,tel);
        painter.drawText(350,300+i,fact+" Dt");
        painter.drawText(650,300+i,entrep);
        painter.drawText(600,300+i,nom_pre);
...
void MainWindow::on_pb_imprime_pdf_clicked()
{QPrinter printer;
...
void MainWindow::on_pb_afficher_f_clicked()
{Fournisseur F2;
...
void MainWindow::on_pb_screenshott_clicked()
{
          s.show();
}
...
void MainWindow::Menu()
{
    ...
    QAction *openAct = fileMenu->addAction(tr("&capture ecran"), this, &MainWindow::on_pb_screenshott_clicked);
...
void MainWindow::on_le_filtre_textChanged(const QString &arg1)
{
    proxyModel->setFilterFixedString(arg1);
}

void MainWindow::on_comboBoxfiltre_currentIndexChanged(int index)
{
    if(index==5){
        index=-1;
    }
...
void MainWindow::on_pb_ajoute_e_clicked()
{   int k=0;
      ui->erreur_EN->clear();
...
void MainWindow::on_pb_changer_e_clicked()
{int k=0;ok=true;
      ui->erreur_EN->clear();
    int id_entreprise=ui->le_id_entreprise->text().toInt();
             QString nom=ui->le_nom_E->text();
...
void MainWindow::on_tab_entreprise_activated(const QModelIndex &index)
{
...
void MainWindow::on_pb_afficher_e_clicked()
{
       ui->tab_entreprise->setModel(EN.charger());
}


void MainWindow::on_pb_supprimer_e_clicked()
{
...
void MainWindow::on_pb_rechercher_e_clicked()
{Entreprise EN1;
...
void MainWindow::on_pb_trier_e_clicked()
{
        Entreprise EN2;
...
void MainWindow::park(int etat_voiture)
{//int i=-1;
...
void MainWindow::on_pb_ajoute_c_clicked()
{   int k=0;
      ui->erreur_c->clear();
...
void MainWindow::on_pb_changer_c_clicked()
{int k=0;ok=true;
      ui->erreur_c->clear();
      int id_commande=ui->le_id_c->text().toInt();
      QDate date_commande=ui->le_date_c->date();
...
void MainWindow::on_tab_commande_activated(const QModelIndex &index)
{
...
void MainWindow::on_pb_afficher_c_clicked()
{
       ui->tab_commande->setModel(c.charger());
}
...
void MainWindow::on_pb_trier_c_clicked()
{
        commande co;
